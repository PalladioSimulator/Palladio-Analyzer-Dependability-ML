...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>uncertainty</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UncertaintyExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.uncertainty"));
				UncertaintyInducedFailureType root = UncertaintyFactory.eINSTANCE.createUncertaintyInducedFailureType();
